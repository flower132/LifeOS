...
export const TASK_ROUTING: Record<AITask, RouteRule> = {
  ...
  GRAPH_SUMMARY: { model: "deepseek-chat", temperature: 0.4, maxTokens: 2048 },
  TIMELINE_SUMMARY: { model: "deepseek-chat", temperature: 0.4, maxTokens: 4096 },
  TIMELINE_QUERY: { model: "deepseek-chat", temperature: 0.1, maxTokens: 1024 },
  LIFE_CHAPTER: { model: "deepseek-chat", temperature: 0.3, maxTokens: 4096 },
  LIFE_REPLAY: { model: "deepseek-chat", temperature: 0.5, maxTokens: 4096 },
  TIME_TRAVEL: { model: "deepseek-chat", temperature: 0.5, maxTokens: 2048 },
...
> = {
  ...
  GRAPH_SUMMARY: "summarize",
  TIMELINE_SUMMARY: "summarize",
  TIMELINE_QUERY: "chat",
  LIFE_CHAPTER: "analyze",
  LIFE_REPLAY: "summarize",
  TIME_TRAVEL: "chat",
